# Create filter definitions for the genomic sample API, using the sqlalchemy class definitions

from db.vdjbase_airr_common import read_definition_data
from db.genomic_db import *
from db.genomic_airr_model import *

filter_file = 'db/genomic_api_query_filters.py'
