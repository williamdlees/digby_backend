...
genomic_sample_filters = {
    ...
    'contig_bam_path': {'model': 'Sample', 'field': Sample.contig_bam_path, 'help': 'Path to the contig file on the server', 'example': ''},
    'reference_assembly': {'model': 'Sample', 'field': Sample.reference_assembly, 'help': 'Name of reference assembly', 'example': ''},
    ...
    'mother_in_study': {'model': 'Patient', 'field': Patient.mother_in_study, 'help': 'Accession number of mother, if included in this study', 'example': 'ABC123'},
    'father_in_study': {'model': 'Patient', 'field': Patient.father_in_study, 'help': 'Accession number of father, if included in this study', 'example': ''},
...
genomic_sequence_filters = {
    'name': {'model': 'Sequence', 'field': Sequence.name, 'help': '', 'example': ''},
    'imgt_name': {'model': 'Sequence', 'field': Sequence.imgt_name, 'help': '', 'example': ''},
    'type': {'model': 'Sequence', 'field': Sequence.type, 'help': '', 'example': ''},
    'novel': {'model': 'Sequence', 'field': Sequence.novel, 'help': '', 'example': ''},
    'appearances': {'model': 'Sequence', 'field': Sequence.appearances, 'sort': 'numeric', 'help': '', 'example': ''},
    'deleted': {'model': 'Sequence', 'field': Sequence.deleted, 'help': '', 'example': ''},
    'functional': {'model': 'Sequence', 'field': Sequence.functional, 'help': '', 'example': ''},
    'notes': {'model': 'Sequence', 'field': Sequence.notes, 'help': '', 'example': ''},
    'sequence': {'model': 'Sequence', 'field': Sequence.sequence, 'help': '', 'example': ''},
    'alias_1': {'model': 'Sequence', 'field': Sequence.alias_1, 'help': '', 'example': ''},
    'alias_2': {'model': 'Sequence', 'field': Sequence.alias_2, 'help': '', 'example': ''},
    'alias_3': {'model': 'Sequence', 'field': Sequence.alias_3, 'help': '', 'example': ''},
    'alias_4': {'model': 'Sequence', 'field': Sequence.alias_4, 'help': '', 'example': ''},
    'alias_5': {'model': 'Sequence', 'field': Sequence.alias_5, 'help': '', 'example': ''},
    'alias_6': {'model': 'Sequence', 'field': Sequence.alias_6, 'help': '', 'example': ''},
    'alias_7': {'model': 'Sequence', 'field': Sequence.alias_7, 'help': '', 'example': ''},
    'alias_8': {'model': 'Sequence', 'field': Sequence.alias_8, 'help': '', 'example': ''},
    'alias_9': {'model': 'Sequence', 'field': Sequence.alias_9, 'help': '', 'example': ''},
    'gapped_sequence': {'model': 'Sequence', 'field': Sequence.gapped_sequence, 'help': '', 'example': ''},
    'max_coverage': {'model': 'Sequence', 'field': Sequence.max_coverage, 'sort': 'numeric', 'help': '', 'example': ''},
    'max_coverage_sample_id': {'model': 'Sequence', 'field': Sequence.max_coverage_sample_id, 'sort': 'numeric', 'help': '', 'example': ''},
    'max_coverage_sample_name': {'model': 'Sequence', 'field': Sequence.max_coverage_sample_name, 'help': '', 'example': ''},
    'gene_name': {'model': 'Gene', 'field': Gene.name.label('gene_name'), 'fieldname': 'name', 'help': '', 'example': ''},
    'gene_type': {'model': 'Gene', 'field': Gene.type.label('gene_type'), 'fieldname': 'type', 'help': '', 'example': ''},
    'family': {'model': 'Gene', 'field': Gene.family, 'help': '', 'example': ''},
    'feature_name': {'model': 'Feature', 'field': Feature.name.label('feature_name'), 'fieldname': 'name', 'help': '', 'example': ''},
    'feature_level': {'model': 'Feature', 'field': Feature.feature_level, 'help': '', 'example': ''},
    'feature_type': {'model': 'Feature', 'field': Feature.feature_type, 'help': '', 'example': ''},
    'feature_seq': {'model': 'Feature', 'field': Feature.feature_seq, 'help': '', 'example': ''},
    'feature_cigar': {'model': 'Feature', 'field': Feature.feature_cigar, 'help': '', 'example': ''},
    'feature': {'model': 'Feature', 'field': Feature.feature, 'help': '', 'example': ''},
    'start': {'model': 'Feature', 'field': Feature.start, 'sort': 'numeric', 'help': '', 'example': ''},
    'end': {'model': 'Feature', 'field': Feature.end, 'sort': 'numeric', 'help': '', 'example': ''},
    'strand': {'model': 'Feature', 'field': Feature.strand, 'help': '', 'example': ''},
    'attribute': {'model': 'Feature', 'field': Feature.attribute, 'help': '', 'example': ''},
    'parent_id': {'model': 'Feature', 'field': Feature.parent_id, 'sort': 'numeric', 'help': '', 'example': ''},
