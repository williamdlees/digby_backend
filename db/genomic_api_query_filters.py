...
genomic_sample_filters = {
    'id': {'model': 'Sample', 'field': Sample.id, 'sort': 'numeric', 'help': '', 'example': '' },
    ...
    'reference_assmebly': {'model': 'Sample', 'field': Sample.reference_assmebly, 'help': 'Name of reference assembly', 'example': '' },
    'id': {'model': 'Patient', 'field': Patient.id, 'sort': 'numeric', 'help': '', 'example': '' },
    ...
    'mother_in_stury': {'model': 'Patient', 'field': Patient.mother_in_stury, 'help': 'Accession number of mother, if included in this study', 'example': 'ABC123' },
    ...
    'id': {'model': 'Study', 'field': Study.id, 'sort': 'numeric', 'help': '', 'example': '' },
    ...
    'id': {'model': 'TissuePro', 'field': TissuePro.id, 'sort': 'numeric', 'help': '', 'example': '' },
    ...
    'id': {'model': 'SeqProtocol', 'field': SeqProtocol.id, 'sort': 'numeric', 'help': '', 'example': '' },
    ...
    'id': {'model': 'DataPro', 'field': DataPro.id, 'sort': 'numeric', 'help': '', 'example': '' },
    ...
    'id': {'model': 'GenoDetection', 'field': GenoDetection.id, 'sort': 'numeric', 'help': '', 'example': '' },

}

genomic_sequence_filters = {
    'id': {'model': 'Sequence', 'field': Sequence.id, 'sort': 'numeric', 'help': '', 'example': '' },
    ...
    'id': {'model': 'Gene', 'field': Gene.id, 'sort': 'numeric', 'help': '', 'example': '' },
    ...
    'locus_order': {'model': 'Gene', 'field': Gene.locus_order, 'sort': 'numeric', 'help': '', 'example': '' },
    'alpha_order': {'model': 'Gene', 'field': Gene.alpha_order, 'sort': 'numeric', 'help': '', 'example': '' },
    'pseudo_gene': {'model': 'Gene', 'field': Gene.pseudo_gene, 'help': '', 'example': '' },
