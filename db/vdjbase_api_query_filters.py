...
sample_info_filters = {
    ...
    'prepro_tool': {'model': 'GenoDetection', 'field': GenoDetection.prepro_tool, 'help': 'Preprocessing tool', 'example': 'PRESTO'},
    'aligner_tool': {'model': 'GenoDetection', 'field': GenoDetection.aligner_tool, 'help': 'Aligner tool', 'example': 'IgBLAST'},
    'aligner_version': {'model': 'GenoDetection', 'field': GenoDetection.aligner_ver.label('aligner_version'), 'fieldname': 'aligner_ver', 'help': 'Aligner version', 'example': '1.18'},
    'aligner_reference_v': {'model': 'GenoDetection', 'field': GenoDetection.aligner_reference_v, 'help': 'Aligner ref V', 'example': 'IMGT full - version 2021-06-06'},
    'aligner_reference_d': {'model': 'GenoDetection', 'field': GenoDetection.aligner_reference_d, 'help': 'Aligner ref D', 'example': 'IMGT full - version 2021-06-06'},
    'aligner_reference_j': {'model': 'GenoDetection', 'field': GenoDetection.aligner_reference_j, 'help': 'Aligner ref J', 'example': 'IMGT full - version 2021-06-06'},
    'Genotyper_Tool': {'model': 'GenoDetection', 'field': GenoDetection.geno_tool.label('Genotyper_Tool'), 'fieldname': 'geno_tool', 'help': 'Genotyping tool', 'example': 'TIgGER'},
    'Genotyper_Version': {'model': 'GenoDetection', 'field': GenoDetection.geno_ver.label('Genotyper_Version'), 'fieldname': 'geno_ver', 'help': 'Genotyping tool version', 'example': '1.2'},
    'Haplotyper_Tool': {'model': 'GenoDetection', 'field': GenoDetection.haplotype_tool.label('Haplotyper_Tool'), 'fieldname': 'haplotype_tool', 'help': 'Haplotyping tool', 'example': 'RabHIT'},
    'Haplotyper_Version': {'model': 'GenoDetection', 'field': GenoDetection.haplotype_ver.label('Haplotyper_Version'), 'fieldname': 'haplotype_ver', 'help': 'Haplotyping tool version', 'example': '1.2'},
    'Single Assignment': {'model': 'GenoDetection', 'field': GenoDetection.single_assignment.label('Single Assignment'), 'fieldname': 'single_assignment', 'help': 'TRUE if the processed reads are restricted to those that have a single V_call', 'example': 'TRUE'},
    'sample_basis': {'model': 'GenoDetection', 'field': GenoDetection.sample_basis, 'help': 'Repertoire or germline', 'example': 'Germline'},
...
sequence_filters = {
    'name': {'model': 'Allele', 'field': Allele.name, 'help': '', 'example': ''},
    ...
    'alias_1': {'model': 'Allele', 'field': Allele.alias_1, 'help': '', 'example': ''},
    'alias_2': {'model': 'Allele', 'field': Allele.alias_2, 'help': '', 'example': ''},
    'alias_3': {'model': 'Allele', 'field': Allele.alias_3, 'help': '', 'example': ''},
    'alias_4': {'model': 'Allele', 'field': Allele.alias_4, 'help': '', 'example': ''},
    'alias_5': {'model': 'Allele', 'field': Allele.alias_5, 'help': '', 'example': ''},
    'alias_6': {'model': 'Allele', 'field': Allele.alias_6, 'help': '', 'example': ''},
    'alias_7': {'model': 'Allele', 'field': Allele.alias_7, 'help': '', 'example': ''},
    'alias_8': {'model': 'Allele', 'field': Allele.alias_8, 'help': '', 'example': ''},
    'alias_9': {'model': 'Allele', 'field': Allele.alias_9, 'help': '', 'example': ''},
