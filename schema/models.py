...
class InferenceProcess(BaseModel):
    field_value: Optional[InferenceProcessEnum] = Field(
        None,
...
class Sex(BaseModel):
    field_value: Optional[SexEnum] = Field(
...
class PcrTargetLocus(BaseModel):
    field_value: Optional[PcrTargetLocusEnum] = Field(
        None,
...
class FileType(BaseModel):
    field_value: Optional[FileTypeEnum] = Field(
        None,
...
class ReadDirection(BaseModel):
    field_value: Optional[ReadDirectionEnum] = Field(
        None,
...
class PairedReadDirection(BaseModel):
    field_value: Optional[PairedReadDirectionEnum] = Field(
        None,
...
class InferenceProcess1(BaseModel):
    field_value: Optional[InferenceProcess1Enum] = Field(
        None,
        description='Information on how the genotype was acquired. Controlled vocabulary.',
        example='repertoire_sequencing',
        title='Genotype acquisition process',
