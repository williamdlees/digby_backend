...
#   timestamp: 2024-08-29T09:35:27+00:00
...
class Genotype(BaseModel):
    ...
    locus: Locus = Field(..., description='Gene locus', examples=['IGH'])
...
class SubjectGenotypeResponse(BaseModel):
    Repertoire: Optional[GenotypeSet] = None
...
class SampleMetadataResponse(BaseModel):
    Repertoire: Optional[Repertoire]        # remove = None once the schema is generated
