        ...
        try:
            ...
            try:
                ...
                if genomic_datasets is not None:
                    genomic_samples = find_genomic_samples([GenomicSample.id, GenomicSample.identifier], args.species, genomic_datasets, genomic_filters)
                else:
                    genomic_samples = []
                ...
                raise BadRequest(f"Malformed request: {e.description}")
