...
class ReportsRunApi(Resource):
    ...
    def get(self, report_name):
        try:
            ...
            # Set test_mode flag here for debugging
            test_mode = False  # Change to False for full run

            run(args.format, args.species, genomic_datasets, genomic_samples, rep_datasets, rep_samples, params, test_mode=test_mode)
